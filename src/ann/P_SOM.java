 ...
 * @author USER
 */
public class P_SOM extends javax.swing.JPanel {

    /**
     * Creates new form P_SOM
     */
    Toolkit toolkit;
    Timer timer;
    double laju;
    public P_SOM() {
        initComponents();
        laju = Double.parseDouble(jTextField4.getText());
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Laju pembelajaran Awal :");

        jTextField4.setText("0.5");

        jLabel7.setText("Fungsi Pembelajaran :");

        jTextField5.setText("0.6");

        jLabel8.setText("Hasil Laju Pembelajaran:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextField6.setText(String.valueOf(laju));
        laju = laju * Double.parseDouble(jTextField5.getText());
